...
import 'package:flutter_skeleton/src/feature/dashboard/model/pokemon.dart';
...
sealed class PokemonEvent {
  ...
  /// Load the pokemons
  const factory PokemonEvent.load({
    Completer? completer,
  }) = _LoadPokemonEvent;
}
...
final class _IdlePokemonState extends PokemonState {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || (other is _IdlePokemonState && other.pokemons == pokemons);
...
final class _LoadingPokemonState extends PokemonState {
  ...
  @override
  bool operator ==(Object other) =>
      identical(this, other) || (other is _LoadingPokemonState && other.pokemons == pokemons);
...
final class _LoadedPokemonState extends PokemonState {
  ...
  @override
  bool operator ==(Object other) =>
      identical(this, other) || (other is _LoadedPokemonState && other.pokemons == pokemons);
...
class PokemonBloc extends Bloc<PokemonEvent, PokemonState> {
  ...
  /// {@macro pokemon_bloc}
  PokemonBloc(this._pokemonRepository) : super(const _IdlePokemonState(pokemons: [])) {
